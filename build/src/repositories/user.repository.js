...
exports.updateUserWithDeleteTweetIdRepo = exports.updateUserWithTweetIdRepo = exports.updateUserRepo = exports.createUserRepo = exports.deleteUserRepo = exports.getUserRepo = void 0;
...
const updateUserRepo = (userId, updatedUser) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.findOneAndUpdate({ uid: userId }, updatedUser, {
            new: true,
        });
        if (result) {
            return true;
...
const updateUserWithDeleteTweetIdRepo = (tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.findOneAndUpdate({ tweets: tweetId }, { $pull: { tweets: tweetId } });
        if (result) {
            return true;
        }
        else {
...
exports.updateUserWithDeleteTweetIdRepo = updateUserWithDeleteTweetIdRepo;
